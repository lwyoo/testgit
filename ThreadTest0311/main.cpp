...
int main(int argc, char* argv[])
{
    ...
    TextureProvider::CreateInstance(rscPath, 265 * 1024 * 1024, 265 * 1024 * 1024);

    TextureProviderScheduler::GetInstance()->Init();
    qDebug() << "[Main.cpp] Init() end ";
    TextureProviderScheduler::GetInstance()->Run();
    qDebug() << "[Main.cpp] Run() end";
